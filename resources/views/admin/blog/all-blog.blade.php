...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Post Page</h3>
                <ul class="breadcrumb">
            ...
            <div class="col-auto float-right ml-auto">
                ...
                <a href="{{ url('/posts') }}" style="display: none;" id="returnBack" class="btn add-btn"><i class="fa fa-arrow-left"></i>Return</a>
            </div>
        </div>
    </div>
    <!-- /Page Header -->
                            ...
                            <td class="text-center">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="/edit-blog/{{ $post->id}}">
                                            <i class="fa fa-pencil m-r-5">
                                            </i> Edit
                                        </a>
                                        <a class="dropdown-item" href="#deleteBlog" data-toggle="modal" onclick="deleteItem({{$post->id}})" data-target="deleteBlog"><i class="fa fa-trash-o m-r-5"></i>
                                            Delete</a>
                                    </div>
                                </div>
                            </td>
                ...
                <div class="form-group">
                    ...
                    <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <select class="select" name="header">
                                    ...
                                    <option value="blog">Recent Events & Activities</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor" name="description" class="form-control" placeholder="Write here Description"></textarea>
                        </div>
                        <div class="form-group">
...
<script>
    function deleteItem(id) {
        document.getElementById("deleteId").href = "delete-blog/" + id;
