...
@section('admin')
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    ...
                    <a href="{{ url('/all-download') }}" style="display: none;" id="returnBack" class="btn add-btn"><i
                            ...
                            @foreach ($downloads as $key =>  $download)
                                <tr>
                                    ...
                                    <td> {{ $download->title }} </td>
                                     <td> <img src="uploads/download/{{ $download->image }} " width="100px"> </td> 
                                    </td>
                                    <td class="text-center">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="#deleteBlog" data-toggle="modal"
                                                    onclick="deleteItem({{$download->id}})"
                                                    data-target="deleteBlog"><i class="fa fa-trash-o m-r-5"></i>
                                                    Delete</a>
                                            </div>
                                        </div>
                                    </td>
            ...
            <div class="card" style="width: 100%;">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <form action="{{ route('store.download') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select class="select" name="header">
                                        ...
                                        <option value="syallabus">Syllabus</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <script>
        function deleteItem(id) {
               document.getElementById("deleteId").href = "delete-download/" + id;
